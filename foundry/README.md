...
### Success Use Case 2: Trusted NFT Loan
 ...
 Example: You promise that `if` I `transfer D_D(id:306)` to you -> `D_D.transferFrom(you,me,306) && CODE.transferFrom(you,me,100) [true]` 100 days from now.

### Peak Success Use Case 3: 
